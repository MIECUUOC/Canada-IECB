            ...
            <div
                ...
                <div className="lg:w-1/2">
                    <div className="h-64 bg-cover lg:h-full">
                        <img className="w-full h-full" src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt=""/>
                    </div>
                </div>
                ...
                <div className="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
                    ...
                    <p className="mt-4 text-gray-500">
                        ...
                        Quidem modi reprehenderit vitae exercitationem aliquid dolores ullam temporibus enim expedita
                        aperiam
